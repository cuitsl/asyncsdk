...
using System.IO;
using ASync.eTermCommand.Exception;
using System.Text.RegularExpressions;
using ASync.eTermCommand.Utils;
...
namespace ASync.eTermCommand.Base {
    ...
    public abstract class ASynCommand:ASyncBase {
        ...
        */
        ...
        public void Connect(string address, int port, string userName, string userPass) {
            base.Connect(address, port, false);
