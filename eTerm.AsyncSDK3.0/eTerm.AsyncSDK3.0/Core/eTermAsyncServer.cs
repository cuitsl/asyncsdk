        ...
        protected override void FireOnReadPacket(AsyncEventArgs<eTerm363Packet,eTerm363Packet, eTerm363Session> e) {
            ...
            if (e.InPacket.Sequence == 1) {
                ...
                if (base.TSessionValidate != null && base.TSessionValidate(e.Session, e.InPacket, out ValidateMessage)) {
                    ...
                    /*
                    e.Session.SendPacket(new byte[]{
                        01,0xFD,0x00,0x06,0x00,0x00,0x01,0x00,0x00,0x2C,0x00,0x00,0x00,0x01,0x39,0x51
                        ,0x70,0x02,0x1B,0x0B,0x20,0x20,0x0F,0x1B,0x4D,0x77,0x78,0x7A,0x6C,0x20,0x73,0x6D
                        ,0x69,0x74,0x61,0x63,0x20,0x73,0x79,0x73,0x74,0x65,0x6D,0x20,0x20,0x0D,0x1E,0x1B
                        ,0x62,0x03,0x01,0xFD,0x00,0x06,0x00,0x0C,0x01,0xFD,0x00,0x06,0x00,0x29,0x01,0x00
                        ,0x00,0x2C,0x00,0x00,0x00,0x01,0x39,0x51,0x70,0x02,0x1B,0x0B,0x20,0x20,0x0F,0x1B
                        ,0x4D,0x77,0x78,0x7A,0x6C,0x20,0x73,0x6D,0x69,0x74,0x61,0x63,0x20,0x73,0x79,0x73
                        ,0x74,0x65,0x6D,0x20,0x20,0x0D,0x1E,0x1B,0x62,0x03
                    });
                    */
                }
                else {
