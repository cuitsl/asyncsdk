...
using System.Collections;
	...
	/// <example>
	/// <code>
	///		from = new EmailAddress("FORCE0908@GMAIL.COM", "Support");
    ///		to = new EmailAddress("FORCE0908@GMAIL.com", "FORCE");
	///
	///		msg = new MailMessage(from, to);
	///		msg.Subject = "Testing .Net SMTP component";
    ///		msg.Body = "Hello GMAIL.";
	/// 
