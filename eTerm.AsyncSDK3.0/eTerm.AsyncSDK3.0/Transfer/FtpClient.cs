...
namespace eTerm.AsyncSDK
{
	...
	public class FtpClient
	{
        ...
        private Encoding __ftpEncoding = Encoding.GetEncoding(@"gb2312");
        /// <summary>
        /// Gets or sets the FTP encoding.
        /// </summary>
        /// <value>The FTP encoding.</value>
        public Encoding FtpEncoding { set { __ftpEncoding = value; } private get { return this.__ftpEncoding; } }
		...
		public void Login()
		{
			...
			//IPAddress addr = null;
			IPEndPoint ep = null;
            foreach (IPAddress addr in Dns.GetHostEntry(this.server).AddressList)
            {
                try
                {
		...
		public string[] GetFileList(string mask)
		{
			...
			while( timeout > DateTime.Now )
			{
                ...
                this.message += FtpEncoding.GetString(buffer, 0, bytes);
		...
		private string readLine()
		{
			while(true)
			{
                ...
                this.message += FtpEncoding.GetString(this.buffer, 0, this.bytes);
		...
		private void sendCommand(String command)
		{
            ...
            Byte[] cmdBytes = FtpEncoding.GetBytes((command + "\r\n").ToCharArray());
