...
namespace eTerm.ASynClientSDK.Utils {
    ...
    /// 转换抽象类
    /// </summary>
    public abstract class ConvertUtil : IConverting {
        /// <summary>
        /// 被转换的值
        /// </summary>
        ...
        Type IConverting.ToType(bool throwError) {
            Type type = null;
            try {
                type = TypeUtil.CreateType(this.ConvertingValue, throwError);
            }
            catch (System.Exception e) {
                if (throwError) {
                    throw new System.Exception("转换成Type时错误", e);
                }
            }
            return type;
        }
        ...
        object IConverting.ToObject(Type expectedType, bool throwError, params object[] parameters) {
            return TypeUtil.CreateObject(this.ConvertingValue, expectedType, throwError, parameters);
        }
        ...
        /// <summary>
        /// 日期转换工具（20MAY11-->2011-03-2;20MAY-->2011-03-20）.
        /// </summary>
