...
namespace AsyncSDK {
    public partial class frmMain : Form {
        ...
        /// 线程UI代理
        /// </summary>
        private delegate void AppendAddInButtonDelegate(ButtonX PlugInButton);
        #endregion
        ...
        private void btnRelease_Click(object sender, EventArgs e) {
            (this.lstAsync.SelectedItems[0].Tag as eTerm443Async).TSession = null;
        }

        private void lstSession_SelectedIndexChanged(object sender, EventArgs e) {
            btnSendMessage.Enabled = this.lstSession.SelectedItems.Count > 0;
        }
    }
}
