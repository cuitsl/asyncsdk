...
namespace ASync.eTermPlugIn
{
    ...
    public partial class ASync_BaseFare: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<ASync_BaseFare>(new ASync.eTermPlugIn.ASyncDB());
        }
        ...
        ASync.eTermPlugIn.ASyncDB _db;
        public ASync_BaseFare(string connectionString, string providerName) {

            _db=new ASync.eTermPlugIn.ASyncDB(connectionString, providerName);
            Init();            
         }
        ...
        public ASync_BaseFare(){
             _db=new ASync.eTermPlugIn.ASyncDB();
            Init();            
        }
        ...
        internal static IRepository<ASync_BaseFare> GetRepo(string connectionString, string providerName){
            ASync.eTermPlugIn.ASyncDB db;
            if(String.IsNullOrEmpty(connectionString)){
                db=new ASync.eTermPlugIn.ASyncDB();
            }else{
                db=new ASync.eTermPlugIn.ASyncDB(connectionString, providerName);
            }
            IRepository<ASync_BaseFare> _repo;
        ...
        public IQueryable<ASync_RealityFare> ASync_RealityFares
        {
            get
            {
                  ...
                  var repo=ASync.eTermPlugIn.ASync_RealityFare.GetRepo();
    ...
    public partial class ASync_RealityFare: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<ASync_RealityFare>(new ASync.eTermPlugIn.ASyncDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
        ...
        public IQueryable<ASync_BaseFare> ASync_BaseFares
        {
            get
            {
                  ...
                  var repo=ASync.eTermPlugIn.ASync_BaseFare.GetRepo();
                  return from items in repo.GetAll()
                       where items.DepartureCity == _DepartureCity
                       select items;
            }
    ...
    public partial class ASync_CityCode: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<ASync_CityCode>(new ASync.eTermPlugIn.ASyncDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class Async_Log: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Async_Log>(new ASync.eTermPlugIn.ASyncDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class Async_PNR: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<Async_PNR>(new ASync.eTermPlugIn.ASyncDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
    ...
    public partial class ASync_AirLine: IActiveRecord
    {
        ...
        static void SetTestRepo(){
            _testRepo = _testRepo ?? new TestRepository<ASync_AirLine>(new ASync.eTermPlugIn.ASyncDB());
        }
        public static void ResetTestRepo(){
            _testRepo = null;
            SetTestRepo();
